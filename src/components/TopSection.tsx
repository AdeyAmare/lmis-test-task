    ...
    <div className="container mx-auto mt-8">
      <div className="grid grid-cols-5 gap-4">
        <div className="shadow-md p-4 rounded-md flex flex-col justify-center gap-1">
          <img src='src/assets/icons/totalcoc.svg' width={40} className='mb-1 ' />
        ...
        <div className="shadow-md  p-4 rounded-md flex flex-col justify-center gap-1">
          <img src='src/assets/icons/totalcom.svg' width={40} className='mb-1 ' />
        ...
        <div className="shadow-md p-4 rounded-md flex flex-col justify-center gap-1">
          <img src='src/assets/icons/totalpassed.svg' width={40} className='mb-1 ' />
